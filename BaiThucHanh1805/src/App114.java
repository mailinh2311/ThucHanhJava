...
public class App114 {
  public static void main(String[] args){
    ...
    hashMap.put("1", new Student("2021050394", "Nguyen Thi Mai Linh", "C2"));
    hashMap.put("2", new Student("2021050395", "Nguyen Tung Linh", "C1"));
    hashMap.put("3", new Student("2021050396", "Phan Huyen Linh", "C2"));
    hashMap.put("4", new Student("2021050398", "Nguyen Thi Loan", "C1"));

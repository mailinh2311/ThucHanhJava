...
public class App41 {
    public static void main(String[] args){
        ...
        if(i < 0 || i > LinkedList.size()-1){
            System.out.println("Chi so can lay phai lon hơn 0 va nho hơn " + (LinkedList.size()-1));
        } else{
        ...
        System.out.println("Phan tu dau tiên trong linkList la: " + firstNode + "; Phan tu cuoi cungtrong danh sach la: " + lastNode);
    }
}
